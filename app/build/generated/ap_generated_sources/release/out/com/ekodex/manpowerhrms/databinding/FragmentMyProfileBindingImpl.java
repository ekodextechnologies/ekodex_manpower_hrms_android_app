...
public class FragmentMyProfileBindingImpl extends FragmentMyProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.floatingActionButton2, 7);
        sViewsWithIds.put(R.id.floatingActionButton3, 8);
        sViewsWithIds.put(R.id.cardView7, 9);
        sViewsWithIds.put(R.id.imageView10, 10);
        sViewsWithIds.put(R.id.textView25, 11);
        sViewsWithIds.put(R.id.cardView6, 12);
        sViewsWithIds.put(R.id.imageView13, 13);
        sViewsWithIds.put(R.id.textView26, 14);
        sViewsWithIds.put(R.id.cardView8, 15);
        sViewsWithIds.put(R.id.imageView15, 16);
        sViewsWithIds.put(R.id.textView27, 17);
        sViewsWithIds.put(R.id.cardView10, 18);
        sViewsWithIds.put(R.id.imageView16, 19);
        sViewsWithIds.put(R.id.textView28, 20);
        sViewsWithIds.put(R.id.cardView9, 21);
        sViewsWithIds.put(R.id.imageView14, 22);
        sViewsWithIds.put(R.id.textView38, 23);
        sViewsWithIds.put(R.id.cardView11, 24);
        sViewsWithIds.put(R.id.imageView17, 25);
        sViewsWithIds.put(R.id.textView39, 26);
    }
    // views
    @NonNull
