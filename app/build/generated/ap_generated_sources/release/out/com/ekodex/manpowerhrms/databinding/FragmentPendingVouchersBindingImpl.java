...
public class FragmentPendingVouchersBindingImpl extends FragmentPendingVouchersBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.pendingVouchersList, 3);
        sViewsWithIds.put(R.id.textView472, 4);
        sViewsWithIds.put(R.id.textView473, 5);
        sViewsWithIds.put(R.id.textView474, 6);
        sViewsWithIds.put(R.id.textView475, 7);
        sViewsWithIds.put(R.id.addLeave, 8);
    ...
    public FragmentPendingVouchersBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 25, sIncludes, sViewsWithIds));
    }
    private FragmentPendingVouchersBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
