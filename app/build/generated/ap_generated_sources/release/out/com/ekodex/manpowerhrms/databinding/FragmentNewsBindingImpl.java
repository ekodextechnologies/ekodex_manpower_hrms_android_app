...
public class FragmentNewsBindingImpl extends FragmentNewsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.newsList, 1);
        ...
        sViewsWithIds.put(R.id.button9, 7);
        sViewsWithIds.put(R.id.button10, 8);
        sViewsWithIds.put(R.id.button11, 9);
        sViewsWithIds.put(R.id.button12, 10);
        sViewsWithIds.put(R.id.button13, 11);
        sViewsWithIds.put(R.id.button14, 12);
        sViewsWithIds.put(R.id.button15, 13);
        sViewsWithIds.put(R.id.searchView, 14);
    }
    // views
    @NonNull
    ...
    private FragmentNewsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (android.widget.SearchView) bindings[14]
