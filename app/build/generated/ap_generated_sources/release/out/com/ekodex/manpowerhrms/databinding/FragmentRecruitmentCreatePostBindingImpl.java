...
public class FragmentRecruitmentCreatePostBindingImpl extends FragmentRecruitmentCreatePostBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView111, 32);
        sViewsWithIds.put(R.id.textView116, 33);
    }
    // views
    @NonNull
    ...
    public FragmentRecruitmentCreatePostBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 34, sIncludes, sViewsWithIds));
    }
    private FragmentRecruitmentCreatePostBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
