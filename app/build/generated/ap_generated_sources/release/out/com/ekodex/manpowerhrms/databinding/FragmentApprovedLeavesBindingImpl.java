...
public class FragmentApprovedLeavesBindingImpl extends FragmentApprovedLeavesBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.approvedLeaveList, 1);
        sViewsWithIds.put(R.id.addLeave, 2);
    ...
    public FragmentApprovedLeavesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private FragmentApprovedLeavesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
