...
public class FragmentRejectedLeavesBindingImpl extends FragmentRejectedLeavesBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.textView79, 1);
        sViewsWithIds.put(R.id.rejectedLeaveList, 2);
    ...
    public FragmentRejectedLeavesBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private FragmentRejectedLeavesBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
