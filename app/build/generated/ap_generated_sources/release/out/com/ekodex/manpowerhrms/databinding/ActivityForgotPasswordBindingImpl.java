...
public class ActivityForgotPasswordBindingImpl extends ActivityForgotPasswordBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.splash_logo, 2);
        ...
        sViewsWithIds.put(R.id.buttonVerifyEmail, 7);
        sViewsWithIds.put(R.id.editTextRecoveryKey, 8);
        sViewsWithIds.put(R.id.editTextNewPassword, 9);
        sViewsWithIds.put(R.id.editTextConfirmPassword, 10);
        sViewsWithIds.put(R.id.buttonResetPassword, 11);
        sViewsWithIds.put(R.id.textViewSignIn, 12);
        sViewsWithIds.put(R.id.imageView61, 13);
    }
    // views
    @NonNull
