...
public class SupervisorAttendanceFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private SupervisorAttendanceFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private SupervisorAttendanceFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static SupervisorAttendanceFragmentArgs fromBundle(@NonNull Bundle bundle) {
    SupervisorAttendanceFragmentArgs __result = new SupervisorAttendanceFragmentArgs();
    bundle.setClassLoader(SupervisorAttendanceFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static SupervisorAttendanceFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    SupervisorAttendanceFragmentArgs that = (SupervisorAttendanceFragmentArgs) object;
  ...
  public String toString() {
    return "SupervisorAttendanceFragmentArgs{"
        + "status=" + getStatus()
        + ", from=" + getFrom()
        + ", to=" + getTo()
        + "}";
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull SupervisorAttendanceFragmentArgs original) {
    ...
    @NonNull
    public SupervisorAttendanceFragmentArgs build() {
      SupervisorAttendanceFragmentArgs result = new SupervisorAttendanceFragmentArgs(arguments);
      return result;
    }
