...
public class PendingVouchersFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private PendingVouchersFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private PendingVouchersFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static PendingVouchersFragmentArgs fromBundle(@NonNull Bundle bundle) {
    PendingVouchersFragmentArgs __result = new PendingVouchersFragmentArgs();
    bundle.setClassLoader(PendingVouchersFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static PendingVouchersFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    PendingVouchersFragmentArgs that = (PendingVouchersFragmentArgs) object;
  ...
  public String toString() {
    return "PendingVouchersFragmentArgs{"
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull PendingVouchersFragmentArgs original) {
    ...
    @NonNull
    public PendingVouchersFragmentArgs build() {
      PendingVouchersFragmentArgs result = new PendingVouchersFragmentArgs(arguments);
      return result;
    }
