...
public class AddSplitVoucherFragmentDirections {
  private AddSplitVoucherFragmentDirections() {
  }

  @NonNull
  public static NavDirections actionAddSplitVoucherFragmentSelf() {
    return new ActionOnlyNavDirections(R.id.action_addSplitVoucherFragment_self);
  }

  @NonNull
  public static ActionAddSplitVoucherFragmentToVoucherManagementFragment actionAddSplitVoucherFragmentToVoucherManagementFragment(
      @NonNull String fromDate, @NonNull String toDate) {
    return new ActionAddSplitVoucherFragmentToVoucherManagementFragment(fromDate, toDate);
  }

  public static class ActionAddSplitVoucherFragmentToVoucherManagementFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionAddSplitVoucherFragmentToVoucherManagementFragment(@NonNull String fromDate,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddSplitVoucherFragmentToVoucherManagementFragment setFromDate(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddSplitVoucherFragmentToVoucherManagementFragment setToDate(
        @NonNull String toDate) {
      if (toDate == null) {
        throw new IllegalArgumentException("Argument \"to_date\" is marked as non-null but was passed a null value.");
      }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddSplitVoucherFragmentToVoucherManagementFragment setOpenTab(int openTab) {
    ...
    public int getActionId() {
      return R.id.action_addSplitVoucherFragment_to_voucherManagementFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionAddSplitVoucherFragmentToVoucherManagementFragment that = (ActionAddSplitVoucherFragmentToVoucherManagementFragment) object;
    ...
    public String toString() {
      return "ActionAddSplitVoucherFragmentToVoucherManagementFragment(actionId=" + getActionId() + "){"
