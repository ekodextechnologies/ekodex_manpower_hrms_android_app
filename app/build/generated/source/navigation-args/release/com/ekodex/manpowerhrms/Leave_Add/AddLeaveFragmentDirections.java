...
public class AddLeaveFragmentDirections {
  private AddLeaveFragmentDirections() {
  }

  @NonNull
  public static ActionAddLeaveFragmentToLeavesManagementFragment actionAddLeaveFragmentToLeavesManagementFragment(
      @NonNull String fromDate, @NonNull String toDate) {
    return new ActionAddLeaveFragmentToLeavesManagementFragment(fromDate, toDate);
  }

  public static class ActionAddLeaveFragmentToLeavesManagementFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionAddLeaveFragmentToLeavesManagementFragment(@NonNull String fromDate,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddLeaveFragmentToLeavesManagementFragment setFromDate(@NonNull String fromDate) {
      if (fromDate == null) {
        throw new IllegalArgumentException("Argument \"from_date\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("from_date", fromDate);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddLeaveFragmentToLeavesManagementFragment setToDate(@NonNull String toDate) {
      if (toDate == null) {
        throw new IllegalArgumentException("Argument \"to_date\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("to_date", toDate);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddLeaveFragmentToLeavesManagementFragment setOpenTab(int openTab) {
    ...
    public int getActionId() {
      return R.id.action_addLeaveFragment_to_leavesManagementFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionAddLeaveFragmentToLeavesManagementFragment that = (ActionAddLeaveFragmentToLeavesManagementFragment) object;
    ...
    public String toString() {
      return "ActionAddLeaveFragmentToLeavesManagementFragment(actionId=" + getActionId() + "){"
