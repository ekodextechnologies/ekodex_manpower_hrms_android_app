...
public class PaidVouchersFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private PaidVouchersFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private PaidVouchersFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static PaidVouchersFragmentArgs fromBundle(@NonNull Bundle bundle) {
    PaidVouchersFragmentArgs __result = new PaidVouchersFragmentArgs();
    bundle.setClassLoader(PaidVouchersFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static PaidVouchersFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    PaidVouchersFragmentArgs that = (PaidVouchersFragmentArgs) object;
  ...
  public String toString() {
    return "PaidVouchersFragmentArgs{"
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull PaidVouchersFragmentArgs original) {
    ...
    @NonNull
    public PaidVouchersFragmentArgs build() {
      PaidVouchersFragmentArgs result = new PaidVouchersFragmentArgs(arguments);
      return result;
    }
