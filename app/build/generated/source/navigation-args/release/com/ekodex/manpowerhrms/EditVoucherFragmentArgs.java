...
public class EditVoucherFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private EditVoucherFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private EditVoucherFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static EditVoucherFragmentArgs fromBundle(@NonNull Bundle bundle) {
    EditVoucherFragmentArgs __result = new EditVoucherFragmentArgs();
    bundle.setClassLoader(EditVoucherFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static EditVoucherFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    EditVoucherFragmentArgs that = (EditVoucherFragmentArgs) object;
  ...
  public String toString() {
    return "EditVoucherFragmentArgs{"
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull EditVoucherFragmentArgs original) {
    ...
    @NonNull
    public EditVoucherFragmentArgs build() {
      EditVoucherFragmentArgs result = new EditVoucherFragmentArgs(arguments);
      return result;
    }
