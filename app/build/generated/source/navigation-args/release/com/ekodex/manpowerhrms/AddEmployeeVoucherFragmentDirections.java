...
public class AddEmployeeVoucherFragmentDirections {
  private AddEmployeeVoucherFragmentDirections() {
  }

  @NonNull
  public static NavDirections actionAddEmployeeVoucherFragmentSelf() {
    return new ActionOnlyNavDirections(R.id.action_addEmployeeVoucherFragment_self);
  }

  @NonNull
  public static ActionAddEmployeeVoucherFragmentToVoucherManagementFragment actionAddEmployeeVoucherFragmentToVoucherManagementFragment(
      @NonNull String fromDate, @NonNull String toDate) {
    return new ActionAddEmployeeVoucherFragmentToVoucherManagementFragment(fromDate, toDate);
  }

  public static class ActionAddEmployeeVoucherFragmentToVoucherManagementFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionAddEmployeeVoucherFragmentToVoucherManagementFragment(@NonNull String fromDate,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddEmployeeVoucherFragmentToVoucherManagementFragment setFromDate(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddEmployeeVoucherFragmentToVoucherManagementFragment setToDate(
        @NonNull String toDate) {
      if (toDate == null) {
        throw new IllegalArgumentException("Argument \"to_date\" is marked as non-null but was passed a null value.");
      }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddEmployeeVoucherFragmentToVoucherManagementFragment setOpenTab(int openTab) {
    ...
    public int getActionId() {
      return R.id.action_addEmployeeVoucherFragment_to_voucherManagementFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionAddEmployeeVoucherFragmentToVoucherManagementFragment that = (ActionAddEmployeeVoucherFragmentToVoucherManagementFragment) object;
    ...
    public String toString() {
      return "ActionAddEmployeeVoucherFragmentToVoucherManagementFragment(actionId=" + getActionId() + "){"
