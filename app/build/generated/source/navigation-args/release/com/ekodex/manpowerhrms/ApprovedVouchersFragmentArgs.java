...
public class ApprovedVouchersFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private ApprovedVouchersFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private ApprovedVouchersFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static ApprovedVouchersFragmentArgs fromBundle(@NonNull Bundle bundle) {
    ApprovedVouchersFragmentArgs __result = new ApprovedVouchersFragmentArgs();
    bundle.setClassLoader(ApprovedVouchersFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static ApprovedVouchersFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    ApprovedVouchersFragmentArgs that = (ApprovedVouchersFragmentArgs) object;
  ...
  public String toString() {
    return "ApprovedVouchersFragmentArgs{"
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull ApprovedVouchersFragmentArgs original) {
    ...
    @NonNull
    public ApprovedVouchersFragmentArgs build() {
      ApprovedVouchersFragmentArgs result = new ApprovedVouchersFragmentArgs(arguments);
      return result;
    }
