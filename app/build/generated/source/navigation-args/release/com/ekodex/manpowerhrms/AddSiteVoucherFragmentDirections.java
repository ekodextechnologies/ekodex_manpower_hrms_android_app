...
public class AddSiteVoucherFragmentDirections {
  private AddSiteVoucherFragmentDirections() {
  }

  @NonNull
  public static NavDirections actionAddSiteVoucherFragmentSelf() {
    return new ActionOnlyNavDirections(R.id.action_addSiteVoucherFragment_self);
  }

  @NonNull
  public static ActionAddSiteVoucherFragmentToVoucherManagementFragment actionAddSiteVoucherFragmentToVoucherManagementFragment(
      @NonNull String fromDate, @NonNull String toDate) {
    return new ActionAddSiteVoucherFragmentToVoucherManagementFragment(fromDate, toDate);
  }

  public static class ActionAddSiteVoucherFragmentToVoucherManagementFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionAddSiteVoucherFragmentToVoucherManagementFragment(@NonNull String fromDate,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddSiteVoucherFragmentToVoucherManagementFragment setFromDate(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddSiteVoucherFragmentToVoucherManagementFragment setToDate(
        @NonNull String toDate) {
      if (toDate == null) {
        throw new IllegalArgumentException("Argument \"to_date\" is marked as non-null but was passed a null value.");
      }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionAddSiteVoucherFragmentToVoucherManagementFragment setOpenTab(int openTab) {
    ...
    public int getActionId() {
      return R.id.action_addSiteVoucherFragment_to_voucherManagementFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionAddSiteVoucherFragmentToVoucherManagementFragment that = (ActionAddSiteVoucherFragmentToVoucherManagementFragment) object;
    ...
    public String toString() {
      return "ActionAddSiteVoucherFragmentToVoucherManagementFragment(actionId=" + getActionId() + "){"
