...
public class VoucherManagementFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private VoucherManagementFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private VoucherManagementFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static VoucherManagementFragmentArgs fromBundle(@NonNull Bundle bundle) {
    VoucherManagementFragmentArgs __result = new VoucherManagementFragmentArgs();
    bundle.setClassLoader(VoucherManagementFragmentArgs.class.getClassLoader());
    ...
    if (bundle.containsKey("openTab")) {
      int openTab;
      openTab = bundle.getInt("openTab");
      __result.arguments.put("openTab", openTab);
    } else {
      __result.arguments.put("openTab", 0);
    }
    return __result;
  }
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static VoucherManagementFragmentArgs fromSavedStateHandle(
    ...
    if (savedStateHandle.contains("openTab")) {
      int openTab;
      openTab = savedStateHandle.get("openTab");
      __result.arguments.put("openTab", openTab);
    } else {
      __result.arguments.put("openTab", 0);
    }
  ...
  public SavedStateHandle toSavedStateHandle() {
    ...
    if (arguments.containsKey("openTab")) {
      int openTab = (int) arguments.get("openTab");
      __result.set("openTab", openTab);
    } else {
      __result.set("openTab", 0);
    }
    return __result;
  }
  ...
  public boolean equals(Object object) {
    ...
    VoucherManagementFragmentArgs that = (VoucherManagementFragmentArgs) object;
  ...
  public String toString() {
    return "VoucherManagementFragmentArgs{"
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull VoucherManagementFragmentArgs original) {
    ...
    @NonNull
    public VoucherManagementFragmentArgs build() {
      VoucherManagementFragmentArgs result = new VoucherManagementFragmentArgs(arguments);
      return result;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public Builder setOpenTab(int openTab) {
