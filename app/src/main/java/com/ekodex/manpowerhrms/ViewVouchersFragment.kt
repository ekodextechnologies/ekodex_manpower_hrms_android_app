...
import com.ekodex.manpowerhrms.databinding.FragmentViewVouchersBinding
import org.json.JSONException
import org.json.JSONObject

class ViewVouchersFragment : Fragment() {

    lateinit var binding: FragmentViewVouchersBinding
    lateinit var adapter:ViewVoucherAdapter
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_view_vouchers,
            container,
            false
        )
    ...
    private fun getVouchers() {
        ...
        val stringRequest = object : StringRequest(
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        else
                        {
                            ...
                            for (i in (array.length() - 1) downTo 0) {
                                ...
                                adapter = ViewVoucherAdapter(vouchersList)
            ...
            override fun getParams(): Map<String, String> {
                ...
                var args = ViewVouchersFragmentArgs.fromBundle(requireArguments())
        ...
        stringRequest.tag = "view_voucher"
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        VolleySingleton.getInstance(requireActivity()).requestQueue.cancelAll("view_voucher")
    }
