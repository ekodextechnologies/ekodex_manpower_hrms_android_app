...
class SelectedImagesAdapter(var data: List<Uri>,var frag:String,var activity:FragmentActivity,private val onRemoveClick: (Uri) -> Unit) :
    Adapter<SelectedImagesViewHolder>() {
...
class SelectedImagesViewHolder(itemView: View) : ViewHolder(itemView) {
