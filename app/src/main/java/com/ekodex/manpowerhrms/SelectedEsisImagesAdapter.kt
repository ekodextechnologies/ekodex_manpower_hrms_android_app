...
class SelectedEsisImagesAdapter(var data: List<Uri>, var frag:String, var activity: FragmentActivity, private val onRemoveClick: (Uri) -> Unit) :
    Adapter<SelectedEsisImagesViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectedEsisImagesViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.selected_image_item_view, parent, false)
        return SelectedEsisImagesViewHolder(view)

    }

    override fun onBindViewHolder(holder: SelectedEsisImagesViewHolder, position: Int) {
...
class SelectedEsisImagesViewHolder(itemView: View) : ViewHolder(itemView) {
