...
import com.ekodex.manpowerhrms.databinding.FragmentTravelAccomodationBinding
import org.json.JSONException
import org.json.JSONObject
import java.text.SimpleDateFormat
import java.util.*

class TravelAccomodationFragment : Fragment() {

    lateinit var binding: FragmentTravelAccomodationBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_travel_accomodation,
            container,
            false
        )
        ...
        return binding.root
         ...
         private fun addTravelAccomodation() {
        var traveler1 = ""
...
//        }
        ...
        if (fromDate == "") {
            Toast.makeText(requireContext(), "Please select from travel date!!", Toast.LENGTH_LONG)
                .show()
        } else if (toDate == "") {
            ...
            val stringRequest = object : StringRequest(
                    ...
                    try {
                        ...
                        if (!obj.getBoolean("error")) {
                            ...
                            findNavController().navigate(
                                TravelScheduleFragmentDirections.actionTravelScheduleFragmentToTravelAccomodationFragment(
                                    args.id
                                )
                            )
                ...
                override fun getParams(): Map<String, String> {
                    ...
                    params["check_out_date"] = fromDate
                    params["bill_to_name"] = toDate
                    params["bill_to_phome"] = ""
                    params["bill_to_email"] = destination
                    params["address"] = modeofop
                    params["state"] = toDate
                    params["city"] = traveler1
                    params["pincode"] = destination
                    params["total_amount"] = modeofop
                    params["pay_mode"] = modeofop
...
// Here we can use calendar selected date
        ...
        fun updateToDateLable(calener: Calendar) {
            val myFormat = "dd-MM-yyyy"
            val sdf = SimpleDateFormat(myFormat, Locale.UK)
// Here we can use calendar selected date
