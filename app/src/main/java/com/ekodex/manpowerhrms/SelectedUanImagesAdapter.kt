...
class SelectedUanImagesAdapter(var data: List<Uri>, var frag:String, var activity: FragmentActivity, private val onRemoveClick: (Uri) -> Unit) :
    Adapter<SelectedUanImagesViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectedUanImagesViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.selected_image_item_view, parent, false)
        return SelectedUanImagesViewHolder(view)

    }

    override fun onBindViewHolder(holder: SelectedUanImagesViewHolder, position: Int) {
...
class SelectedUanImagesViewHolder(itemView: View) : ViewHolder(itemView) {
