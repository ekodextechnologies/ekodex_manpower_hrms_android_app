...
class SelectedPanImagesAdapter(var data: List<Uri>, var frag:String, var activity: FragmentActivity, private val onRemoveClick: (Uri) -> Unit) :
    Adapter<SelectedPanImagesViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectedPanImagesViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.selected_image_item_view, parent, false)
        return SelectedPanImagesViewHolder(view)

    }

    override fun onBindViewHolder(holder: SelectedPanImagesViewHolder, position: Int) {
...
class SelectedPanImagesViewHolder(itemView: View) : ViewHolder(itemView) {
