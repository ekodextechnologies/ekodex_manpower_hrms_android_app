...
import com.ekodex.manpowerhrms.databinding.FragmentKycDoneBinding
import org.json.JSONException
import org.json.JSONObject

class KycDoneFragment : Fragment() {

    lateinit var binding: FragmentKycDoneBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_kyc_done, container, false)
...
//            type = savedInstanceState.getString("type", "dummy")
//            Log.i("11111","if block - ${type}")
//        } else {
//            // 2️⃣ If arguments are passed from navigation
//            if (!requireArguments().isEmpty) {
//                val args = KycDoneFragmentArgs.fromBundle(requireArguments())
//                type = if (args.type.isNotEmpty()) args.type else "dummy"
//                Log.i("11111","else block - ${type}")
//            } else {
//                // 3️⃣ Default to current date
//                type = ""
//                Log.i("11111","last else block - ${type}")
//            }
//        }
//
//        // Fetch data
