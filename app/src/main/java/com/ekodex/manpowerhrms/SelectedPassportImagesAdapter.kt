...
class SelectedPassportImagesAdapter(var data: List<Uri>, var frag:String, var activity: FragmentActivity, private val onRemoveClick: (Uri) -> Unit) :
    Adapter<SelectedPassportImagesViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelectedPassportImagesViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.selected_image_item_view, parent, false)
        return SelectedPassportImagesViewHolder(view)

    }

    override fun onBindViewHolder(holder: SelectedPassportImagesViewHolder, position: Int) {
...
class SelectedPassportImagesViewHolder(itemView: View) : ViewHolder(itemView) {
