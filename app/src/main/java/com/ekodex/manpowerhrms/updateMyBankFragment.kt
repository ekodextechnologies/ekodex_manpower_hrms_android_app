...
import com.ekodex.manpowerhrms.databinding.FragmentUpdateMyBankBinding
import org.json.JSONException
import org.json.JSONObject

class updateMyBankFragment : Fragment() {

    lateinit var binding: FragmentUpdateMyBankBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_update_my_bank,
            container,
            false
        )
...
//        }
        ...
        val stringRequest = object : StringRequest(
            Request.Method.POST, URLs.URL_UPDATE_PARTICULAR_BANK_DETAIL,
            Response.Listener { response ->
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        findNavController().navigate(updateMyBankFragmentDirections.actionUpdateMyBankFragmentToMyBanksFragment())
            ...
            override fun getParams(): Map<String, String> {
                ...
                var args = updateMyBankFragmentArgs.fromBundle(requireArguments())
                params["id"] = args.id
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        VolleySingleton.getInstance(requireActivity()).requestQueue.cancelAll("update_bank")
    }

    private fun getBankDetails() {
        val stringRequest = object : StringRequest(
            Request.Method.POST, URLs.URL_GET_PARTICULAR_BANK_DETAILS,
            Response.Listener { response ->
